...
Freelancers and boutique agency owners who prospect for clients. They are digitally fluent, work solo or in small teams, and spend hours each week manually scouting leads across Google Maps, GitHub, Product Hunt, and company websites. Their context is a browser-heavy research workflow: multiple tabs, copy-pasting into spreadsheets, losing context between tools. Primary job: find good-fit businesses → understand them fast → know exactly why to reach out → save and act on them.
...
- Notion (too soft, document-y, wrong affordance density)
- HubSpot (enterprise bloat, visual noise, obvious CRM)
- Apollo.io (data-dump aesthetics, overwhelming tables, zero personality)
- Generic SaaS purple-gradient heroes (the obvious B2B AI tell)
- Vibrant dashboards with metric cards glowing over a dark mesh (hero-metric cliché)
...
WCAG AA minimum across all interactive elements. Reduced-motion respected universally. Dark mode primary (tool aesthetic); system preference respected.
